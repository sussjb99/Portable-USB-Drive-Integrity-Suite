...
This software is designed to be small in size and designed to be portable and it should be installed and run directly from your storage external devices.
